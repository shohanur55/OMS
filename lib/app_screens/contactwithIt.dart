...
class Contactwithit extends StatefulWidget {
  const Contactwithit({super.key});

  @override
  State<Contactwithit> createState() => _ContactwithitState();
}

class _ContactwithitState extends State<Contactwithit> {
  ...
  Future<bool> addRecord() async {
    try {
      DocumentReference docRef = _firestore.collection('ABC Company').doc("withIt");
