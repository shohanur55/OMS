...
class Replymarketing extends StatefulWidget {
  const Replymarketing({super.key});

  @override
  State<Replymarketing> createState() => _ReplymarketingState();
}

class _ReplymarketingState extends State<Replymarketing> {
  ...
  Future<bool> addRecord() async {
    try {
      DocumentReference docRef = _firestore.collection('ABC Company').doc("replyMarketing");
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        title: Text("Contact with Marketing"),
