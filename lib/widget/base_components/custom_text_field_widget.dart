...
class CustomTextFormField extends StatefulWidget {
  const CustomTextFormField({
    super.key,
    this.boxConstraints = const BoxConstraints(minHeight: 24),
          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: FittedBox(child: CircularProgressIndicator(color: widget.loadingIconColor ?? Theme.of(context).primaryColor.withOpacity(0.5))),
              ),
            ],
          );
    } else {
    ...
    return Focus(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          hintStyle: !error ? widget.hintStyle ?? TextStyle(color: Theme.of(context).shadowColor) : widget.errorStyle ?? widget.hintStyle?.copyWith(color: Theme.of(context).colorScheme.error) ?? TextStyle(color: Theme.of(context).colorScheme.error),
          errorStyle: const TextStyle(height: 0),
          contentPadding: widget.contentPadding ?? const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
          enabledBorder: widget.enabledBorder ??
              OutlineInputBorder(
                borderRadius: borderRadius,
                borderSide: BorderSide(width: 2, color: Theme.of(context).primaryColor.withOpacity(0.5)),
              ),
          ...
          disabledBorder: widget.disabledBorder ??
              OutlineInputBorder(
                borderRadius: borderRadius,
                borderSide: BorderSide(width: 2, color: Theme.of(context).primaryColor.withOpacity(0.1)),
              ),
        ),
      ),
    );
